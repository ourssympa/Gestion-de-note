...
<div class="card height-auto">
    <div class="card-body">
        ...
        <form class="new-added-form" method="POST" action="{{route('etudiant.update',$data->id)}}">
            @csrf
            @method('put')
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    <label>E-Mail</label>
                    <input  name="email" value="{{$data->email}}" type="email" placeholder="" class="form-control">
                </div>
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <input name="telephone" value="{{$data->telephone}}" type="text"  class="form-control">
                </div>
